...
from testing.jaffle_shop.orders as orders

join (
      select 
        first_name || ' ' || last_name as name, 
        * 
      from testing.jaffle_shop.customers
) customers
...
join (
    ...
    left outer join testing.stripe.payment c
    on a.id = c.orderid
...
left outer join testing.stripe.payment payments
